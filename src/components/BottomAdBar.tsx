  ...
  return (
    <div className="fixed inset-x-0 bottom-0 z-30 border-t border-border bg-card/95 shadow-elevated backdrop-blur-xl">
      <div className="mx-auto flex w-full max-w-6xl items-center gap-3 px-4 py-2">
        ...
        <div className="min-h-[60px] flex-1 overflow-hidden rounded-lg bg-muted/40">
          <AdSlot
            slot="9988776655"
            format="horizontal"
            style={{ minHeight: 60 }}
        ...
        <button
          ...
          className="rounded-md px-2 py-1 text-xs font-semibold text-muted-foreground transition-colors hover:bg-foreground/5 hover:text-foreground"
          aria-label="Close ad"
        >
          ✕
        </button>
